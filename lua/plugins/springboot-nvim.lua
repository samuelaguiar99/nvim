...
~/.local/share/nvim/lazy/springboot-nvim/lua/springboot-nvim/utils.lua ( function find_main_application_class_directory )
Check in every file in the springboot-nvim files for mkdir and concat all paths given in the mkdir commands '"' .. root_path .. '"' for example
]]--
